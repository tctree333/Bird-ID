...
class Other(commands.Cog):
    ...
    async def botinfo(self, ctx):
        ...
        embed.add_field(name="Support",
                        value="If you are experiencing any issues, have feature requests, or want to get updates on bot status, join our support server at https://discord.gg/fXxYyDJ",
                        inline=False)
    ...
    async def invite(self, ctx):
        ...
        embed.add_field(name="Invite",
                        ...
                        **Orni-Bot:** https://discordapp.com/api/oauth2/authorize?client_id=601755752410906644&permissions=51200&scope=bot\n
                        For more information on the differences between the two bots, visit our support server at https://discord.gg/fXxYyDJ""",
                        inline=False)
        await ctx.send(embed=embed)
